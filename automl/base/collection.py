...
# from automl.base.dochelpers import _str, borrowdoc
from automl.base.types import is_sequence_type
...
class Collection(dict):
    ...
    def __str__(self):
        return ','.join([str(k) for k in sorted(self.keys())])
