...
var assert = require("./graphie/interactive2/interactive-common.js").assert;

const GraphUtils = require("./graphie/util/graph-utils.js");
...
ReactDOM.render(<Graphie />,  document.getElementById('graph-container'));
