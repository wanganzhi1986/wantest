# -*- coding: utf-8 -*-
# Generated by Django 1.9.2 on 2017-04-09 13:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='course.CategoryDict', verbose_name='\u7c7b\u522b')),
            ],
            options={
                'verbose_name': '\u8bfe\u7a0b\u4fe1\u606f',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=50, verbose_name='\u65b9\u5411\u540d\u79f0')),
            ],
        ),
        migrations.CreateModel(
            name='Video',
        ...
        migrations.AddField(
            ...
            name='orient',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='course.OrientDict', verbose_name='\u65b9\u5411'),
        ),
    ]
